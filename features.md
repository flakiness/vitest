...
| 15 | `parallelIndex` | ✅ | Populated from `ModuleDiagnostic.concurrencyId` (available in Vitest 5.0.0 beta+). On older Vitest versions the field is absent and `parallelIndex` is left undefined. See [upstream issue](https://github.com/vitest-dev/vitest/issues/10306). |
