...
| 15 | `parallelIndex` | ✅ | Populated from `ModuleDiagnostic.concurrencyId` (available since Vitest 5.0.0). On Vitest 4.x the field is absent and `parallelIndex` is left undefined. See [upstream issue](https://github.com/vitest-dev/vitest/issues/10306). |
